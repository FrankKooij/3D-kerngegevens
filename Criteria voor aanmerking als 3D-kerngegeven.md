...
De gegevens worden tezamen met andere gegevens gebruikt in toepassingen die het grondgebied van de bronhouder overstijgen of die landelijk zijn | _Als afnemers sommige gegevens alleen lokaal of geïsoleerd binnen een specifiek domein gebruiken, hebben zij er baat bij om die gegevens toegespitst op de lokale situatie of dat domein te ontvangen in plaats van een grootste gemene deler van wat landelijk haalbaar is. Landelijk harmoniseren biedt afnemers dan geen voordelen, terwijl bronhouders er wel keuzevrijheid en flexibiliteit voor zouden moeten inleveren._ |
